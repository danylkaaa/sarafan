  ...
  width="400px")
    div.box
      ...
      b-field
        ...
        output(for="quality") {{stats.quality}}
      p Професійність
      b-field
        ...
        output(for="professionalism") {{stats.professionalism}}
      p Ввічливість
        b-field
          ...
          output(for="sociability") {{stats.sociability}}
      p Порядність
        b-field
          ...
          output(for="attitude") {{stats.attitude}}
